...
import { AdminApproveProviderUseCase, AdminChangeProviderStatusUseCase, AdminFetchProviderAddressUseCase, AdminFetchProviderDetailsUseCase, AdminFetchProviderServiceUseCase, AdminProviderListUseCase } from "../../application/use-cases/admin/adminProvider.use-case";
...
const adminProviderController = new AdminProviderController(adminProviderListUseCase, adminApproveProviderUseCase, adminChangeProviderStatusUseCase, adminFetchProviderDetailsUseCase, adminFetchProviderAddressUseCase, adminFetchProviderServiceUseCase);
