...
import { ProviderSaveSubscriptionUseCase, ProviderSubscribeToPlanUseCase } from "../../application/use-cases/provider/providerSubscription.use-case";
...
const providerSubscriptionController = new ProviderSubscriptionController( providerSubscribeToPlanUseCase, providerSaveSubscriptionUseCase );
